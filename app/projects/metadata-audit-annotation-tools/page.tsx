...
export default function MetadataAuditAnnotationToolsPage() {
  const tech = [
    "Python",
    "SQL",
    "Data Cleaning",
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <GlassCard variant="highlight" className="p-8 md:p-12">
          ...
          <h1 className="max-w-4xl text-5xl font-semibold leading-[0.92] tracking-tight md:text-7xl">
            Metadata Audit & Annotation Tools
          </h1>

          <p className="mt-6 max-w-3xl text-base leading-8 text-[#6B625A] md:text-lg">
            Internal tooling for metadata generation, fixing, audit, annotation, and
            large-scale data rework workflows.
          </p>
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2">
          <GlassCard variant="warm" className="p-8 md:p-10">
            ...
            <p className="mt-6 leading-8 text-[#6B625A]">
              A set of internal tools designed to support metadata workflows, data
              quality checks, annotation, fixes, and high-volume operational processing.
            </p>
          </GlassCard>
          ...
          <GlassCard variant="default" className="p-8 md:p-10">
            ...
            <ul className="mt-6 space-y-4 text-[#6B625A]">
              <li>• Built automation for metadata workflows.</li>
              <li>• Supported data cleaning and audit operations.</li>
              <li>• Developed ad-hoc internal utilities.</li>
              <li>• Worked on scalable data processing support.</li>
            </ul>
          </GlassCard>
        </section>
      </div>
